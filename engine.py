...
class RAGEngine:
    ...
    def __init__(self, vector_db_client):
        ...
        self.collection = self.client.get_collection("document_embeddings")
...
def process_rag(vector_db_client, user_query: str) -> List[Dict[str, str]]:
    """
    RAG 프로세스 실행 함수
    ...
    Returns:
        생성된 테스트케이스 목록
    """
    rag_engine = RAGEngine(vector_db_client)
...
def generate_testcases(vector_db_client, document_chunks: List[Dict[str, Any]]) -> List[Dict[str, str]]:
    """
